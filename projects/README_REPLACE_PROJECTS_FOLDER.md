...
The image-analysis workflow is now folded into the flagship `micromodular-deposition/` case study, and process simulation is omitted until it has a concrete artifact.
