...
The image-analysis workflow is now folded into the flagship `micromodular-deposition/` build log, and process simulation is omitted until it has a concrete artifact.
