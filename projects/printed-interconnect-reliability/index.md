...
subtitle: "Printed conductive lines can look fine on day one and fail later through drift, intermittent opens, or stress damage. I built measurement logic that catches failure classes early enough to feed back into the process."
---
...
<div class="process-map reliability-loop" aria-label="Printed interconnect reliability process-control loop">
 <div class="process-map-stage"><p>FABRICATE</p><span>surface prep</span><span>print interconnect</span><span>cure / handle</span></div><div class="process-map-arrow" aria-hidden="true">→</div><div class="process-map-stage"><p>MEASURE</p><span>initial R</span><span>continuity</span><span>repeat readings</span></div><div class="process-map-arrow" aria-hidden="true">→</div><div class="process-map-stage"><p>STRESS</p><span>humidity / temperature</span><span>time interval</span><span>re-measure</span></div><div class="process-map-arrow" aria-hidden="true">→</div><div class="process-map-stage decision-stage"><p>DECIDE</p><span>pass / monitor / fail / trace back to process step</span></div>
</div>

## Decision framework

| Signal | Failure class | Candidate process response |
|---|---|---|
| High initial resistance | Geometry/deposition/cure issue | Check line geometry, surface prep, print continuity, and cure state. |
| Smooth normalized drift | Stress-sensitive degradation | Compare humidity/temperature exposure and material/cure history. |
| Sudden open circuit | Complete continuity loss | Inspect handling, adhesion, cracking, and interconnect discontinuity. |
| Noisy intermittent readings | Contact/handling artifact or unstable interface | Separate probe/contact artifacts from material aging before changing process parameters. |
...
<div class="two-col"><div class="matrix-card"><h3>Electrical testing</h3><p>Resistance measurements, continuity checks, stress/re-measure intervals, and failure classification.</p></div><div class="matrix-card"><h3>Process feedback</h3><p>Threshold logic that links electrical symptoms to candidate changes in surface prep, printing, cure, or handling.</p></div></div>
