...
<section class="project-equal-grid-section" aria-label="Main projects">
 <div class="portfolio-grid startup-project-grid equal-project-grid build-log-home-grid">
 <article class="portfolio-card evidence-card build-log-card primary-build">
  <div class="card-topline"><span>Wet processing · printed electronics</span><span>2025–present</span><span class="outcome-badge">Screening framework</span></div>
  <h2>Micromodular Electronics Deposition</h2>
  <p class="institution-line">Filler Lab, Georgia Tech</p>
  ...
  <div class="evidence-table compact-evidence-table"><span><strong>Result</strong> Substrate-screening decision framework based on contact-line motion, edge/center ratio, density, and repeatability.</span></div>
 ...
 <article class="portfolio-card evidence-card build-log-card operations-build">
  <div class="card-topline"><span>Operations · quality loops</span><span>2021–2022</span><span class="outcome-badge">+20% throughput</span></div>
  ...
  <div class="evidence-table compact-evidence-table"><span><strong>Result</strong> +20% cars/hour, -15% order-to-handoff time, and ~30% downtime reduction.</span></div>
 ...
 <article class="portfolio-card evidence-card build-log-card">
  <div class="card-topline"><span>Microfluidics · Mayo Clinic</span><span>Summer 2025</span><span class="outcome-badge">20× throughput</span></div>
  ...
  <div class="evidence-table compact-evidence-table"><span><strong>Result</strong> 20× throughput increase and ~50% encapsulation-yield improvement.</span></div>
  <p><a href="{{ '/projects/microencapsulation-process-development/' | relative_url }}">Open build log →</a></p>
 </article>

 <article class="portfolio-card evidence-card build-log-card">
  <div class="card-topline"><span>Reliability · process control</span><span>2025–present</span><span class="outcome-badge">Failure logic</span></div>
  ...
  <div class="evidence-table compact-evidence-table"><span><strong>Result</strong> Go/no-go failure classes that point back to process-step candidates.</span></div>
  <p><a href="{{ '/projects/printed-interconnect-reliability/' | relative_url }}">Open build log →</a></p>
 </article>

 <article class="portfolio-card evidence-card build-log-card">
  <div class="card-topline"><span>Automation · diagnostics · Mayo Clinic</span><span>Summer 2025</span><span class="outcome-badge">Control prototype</span></div>
  ...
  <div class="evidence-table compact-evidence-table"><span><strong>Result</strong> A control prototype organized around ramp rate, settling time, overshoot, steady-state error, and repeatability.</span></div>
...
<section class="additional-work-section compact-additional-section" aria-label="Additional technical work">
 ...
 <div class="additional-evidence-strip five-evidence-strip centered-additional-work">
