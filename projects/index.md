...
<section class="projects-index-hero startup-projects-hero plain-prose-section" aria-label="Engineering Case Files introduction">
...
<section class="case-group flagship-group grouped-case-section" aria-label="Featured case files">
 <div class="case-heading"><span>01</span><h2>Featured</h2></div>
 <div class="portfolio-grid startup-project-grid equal-project-grid casefile-project-grid">
  ...
  <article class="portfolio-card evidence-card build-log-card primary-build" data-tags="wet materials">
   ...
   <p class="metric-callout">Final stains were not enough. Video-derived trajectories made substrate screening more auditable.</p>
   <p class="transferable-line"><strong>Skill carried forward:</strong> substrate-screening and image-derived quality metrics.</p>
...
<section class="case-group grouped-case-section" aria-label="Reliability and control">
 <div class="case-heading"><span>02</span><h2>Reliability &amp; control</h2></div>
 <div class="portfolio-grid startup-project-grid equal-project-grid casefile-project-grid">
  <article class="portfolio-card evidence-card build-log-card" data-tags="reliability wet">
   ...
   <p class="metric-callout">A line can pass time-zero continuity and still show process-built vulnerability under stress.</p>
...
<section class="case-group supporting-group grouped-case-section" aria-label="Materials and workflows">
 <div class="case-heading"><span>03</span><h2>Materials &amp; workflows</h2></div>
 <div class="portfolio-grid startup-project-grid equal-project-grid casefile-project-grid support-case-grid">
  ...
  <article class="portfolio-card evidence-card build-log-card" data-tags="wet automation">
   ...
   <p class="metric-callout">Raw microscopy videos become useful only after calibration, segmentation, and trace QC.</p>
