...
<section class="case-group flagship-group accent-case-group" aria-label="Featured case files">
 <div class="case-heading"><p class="system-label">Featured</p><h2>Wet-lab and deposition systems</h2></div>
 ...
 <img class="case-thumb" src="{{ '/assets/images/artifact-microcapsule-microscopy.jpg' | relative_url }}" alt="Hydrogel microcapsules under microscopy" loading="lazy">
 ...
 <p class="metric-callout">Throughput only counted when flow ratio, tooling, and crosslink timing kept capsules usable.</p>
 ...
 <img class="case-thumb" src="{{ '/assets/images/artifact-microdevice-trajectory-overlay.png' | relative_url }}" alt="Microdevice trajectory overlay thumbnail" loading="lazy">
 ...
 <p class="metric-callout">Final stains were not enough. Video-derived traces gave the screen a real control variable.</p>
 <p class="transferable-line"><strong>Skill carried forward:</strong> substrate screening and image-derived <abbr title="Critical-to-Quality">CTQ</abbr> metrics.</p>
 <p><a href="{{ '/projects/micromodular-deposition/' | relative_url }}">Open case file →</a></p>
 </article>
 </div>
</section>

<section class="case-group accent-case-group" aria-label="Reliability and control">
 <div class="case-heading"><p class="system-label">Reliability &amp; Control</p><h2>Failure logic and automation</h2></div>
 <div class="portfolio-grid startup-project-grid equal-project-grid casefile-project-grid">
 ...
 <p class="metric-callout">A line can pass time-zero continuity and still carry process-built vulnerability under stress.</p>
 ...
 <p class="metric-callout">A setpoint is not validation unless the sample region sees the intended thermal history.</p>
...
<section class="case-group supporting-group accent-case-group" aria-label="Materials and workflows">
 <div class="case-heading"><p class="system-label">Materials &amp; Workflows</p><h2>Characterization, images, and models</h2></div>
 ...
 <h2>Thin-Film Semiconductor Research</h2>
 <p class="metric-callout">Characterization has to answer a process question, not just produce a readout.</p>
 ...
 <p class="metric-callout">Raw microscopy videos become useful only after calibration, segmentation, and trace quality control.</p>
 ...
 <img class="case-thumb" src="{{ '/assets/images/artifact-simulation-flow.svg' | relative_url }}" alt="Process simulation schematic" loading="lazy">
 ...
 <p class="metric-callout">A model is useful only when basis, assumptions, and decision use are explicit.</p>
...
<section class="cta-band project-page-contact-cta tone-dark" aria-label="Project contact call to action">
 <div><h2>Talk through a case file with me.</h2><p>Internships, project work, startup conversations, or technical discussions. I can walk through the experiments, tooling, and what I’d change next.</p></div>
