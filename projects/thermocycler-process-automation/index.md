...
<section class="visual-artifact-grid" aria-label="Visual artifact slots">
 <figure><img src="{{ '/assets/images/thermocycler-profile.svg' | relative_url }}" alt="Thermocycler temperature profile area" loading="lazy"><figcaption>Measurement plot area for setpoint, measured temperature, overshoot, ramp rate, and hold band.</figcaption></figure>
 <figure><img src="{{ '/assets/images/artifact-device-image.svg' | relative_url }}" alt="Thermocycler prototype image area" loading="lazy"><figcaption>Image area for prototype hardware, thermal block, sensor placement, or wiring.</figcaption></figure>
 <figure><img src="{{ '/assets/images/artifact-flow-schematic.svg' | relative_url }}" alt="Thermal control schematic area" loading="lazy"><figcaption>Schematic area for controller, heater/cooler, sensor, and sample-region thermal path.</figcaption></figure>
</section>
