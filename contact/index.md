...
<div class="contact-system-grid contact-reveal refined-contact-grid">
 ...
 <section class="contact-form-panel soft-form-panel email-first-panel" aria-label="Direct email panel">
  <div class="contact-panel-header">
   ...
   <p>Use the email link with a role, project, timeline, location or remote expectations, and the build log that made you reach out.</p>
  </div>
  <div class="email-large-card flat-email-card">
   <span>Email</span>
...
<section class="contact-fit-panel contact-reveal" aria-label="Best-fit conversations">
 ...
 <div class="matrix contact-fit-grid">
  <div class="matrix-card"><h3>Seed / Series A hard-tech</h3><p>Teams where I can be an early ChemE/process hire and help define the first wet-processing or manufacturing measurement loop.</p></div>
