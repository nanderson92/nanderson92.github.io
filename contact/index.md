...
<div class="contact-system-grid contact-reveal">
 ...
 <p>Send a short note with the role or project, timeline, location/remote expectations, and which build log made you reach out.</p>
 </div>
...
<section class="contact-fit-panel contact-reveal" aria-label="Best-fit conversations">
 ...
 <div class="matrix-card"><h3>Seed / Series A hard-tech</h3><p>Teams where I would be the ChemE/process person helping define the first repeatable wet-processing or manufacturing loop.</p></div>
