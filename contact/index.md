...
<div class="contact-system-grid contact-reveal">
 ...
 <h2>Let’s talk process engineering, R&amp;D, and manufacturing.</h2>
 <p>
 ...
 <p>Use this form for recruiting, project conversations, or technical collaboration. The form is wired to my email; direct email is fastest for recruiting conversations.</p>
 </div>
...
<section class="contact-fit-panel contact-reveal" aria-label="Best-fit conversations">
 ...
 <div class="matrix-card"><h3>Early-stage hard-tech teams</h3><p>Comfortable being the ChemE in the room and helping define the first version of a wet-processing, automation, or scale-up workflow.</p></div>
 </div>
</section>
