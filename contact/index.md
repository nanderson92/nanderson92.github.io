...
<div class="contact-system-grid contact-reveal">
 ...
 <span>Seed/Series A hard-tech teams that need a first ChemE/process perspective</span>
 </div>
 ...
 <section class="contact-form-panel soft-form-panel email-first-panel direct-email-panel" aria-label="Direct email panel">
 <div class="contact-panel-header">
 <p class="system-label small">DIRECT EMAIL</p>
 <h2>Email is the fastest route.</h2>
 <p>Send a note with the role, project, timeline, location/remote expectations, and which build log made you reach out.</p>
 </div>
 <div class="email-large-card flattened-email-card">
  <span>Email</span>
...
<section class="contact-fit-panel contact-reveal" aria-label="Best-fit conversations">
 ...
 <div class="matrix-card"><h3>Seed/Series A hard-tech</h3><p>Teams where I would be one of the first ChemE/process people and help turn ambiguous experiments into repeatable operating windows.</p></div>
 <div class="matrix-card"><h3>Process-development work</h3><p>Defining variables, building the measurement loop, and finding the operating window from first principles.</p></div>
